...
//1            2              3                4                5           6             7
    ...
    public static String  draw(String name, String style, String blankSel, String selectVal, Vector keys,Vector vals, String attTag)
        ...
        public static String drawBoostrap(String name, String blankSel, String selectVal, Vector keys,Vector vals, String attTag)
            {
            if (name == null) name = new String("cbbox");
            String s = "";
            String htmlSelect = "<select id=\"" + name + "\" " + " name=\"" + name + "\" class=\""+attTag+"\">\n";
            boolean hasSel = false;
            if (blankSel != null)
                htmlSelect = htmlSelect + "\t<option value=\"\" selected >" + blankSel + "</option>\n";
            for (int i = 0; i < keys.size(); i++)
