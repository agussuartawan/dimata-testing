...
public class Command {
    ...
    //add
    public static final int ADD2 = 222;
    public static final int EDIT = 3;
    public static final int EDIT2 = 333;
    public static final int SAVE = 4;
    public static final int SAVE2 = 444;
    public static final int UPDATE = 5;
    public static final int UPDATE2 = 555;
    public static final int DELETE = 6;
    public static final int DELETE2 = 666;
    ...
    public static final int DOWNLOADDATA = 77;
    
    public static final int UPLOADATA = 78;
    
    public static String commandString[] = {
        "None", "List", "Add", "Add2", "Edit", "Edit2", "Save", "Save2", "Update", "Delete", "Delete2", "Refresh", "View", "Post", "Get",
        ...
        "Ask", "Posting", "Reposting", "Add All", "Save All", "Delete All", "Download Data","Upload Data"
    };
}
