...
public class PstAppUser extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static JSONObject fetchJSON(AppUser entAppUser) {
      ...
      try {
         ...
         object.put(PstAppUser.fieldNames[PstAppUser.FLD_REG_DATE],
               (entAppUser.getRegDate() != null) ? Formater.formatDate(entAppUser.getRegDate(), "yyyy-MM-dd HH:mm:ss")
                     : "0000-00-00 00:00:00");
         object.put(PstAppUser.fieldNames[PstAppUser.FLD_UPDATE_DATE],
               (entAppUser.getUpdateDate() != null)
                     ? Formater.formatDate(entAppUser.getUpdateDate(), "yyyy-MM-dd HH:mm:ss")
                     : "0000-00-00 00:00:00");
         object.put(PstAppUser.fieldNames[PstAppUser.FLD_USER_STATUS], "" + entAppUser.getUserStatus());
         object.put(PstAppUser.fieldNames[PstAppUser.FLD_LAST_LOGIN_DATE],
               (entAppUser.getLastLoginDate() != null)
                     ? Formater.formatDate(entAppUser.getLastLoginDate(), "yyyy-MM-dd HH:mm:ss")
                     : "0000-00-00 00:00:00");
         object.put(PstAppUser.fieldNames[PstAppUser.FLD_LAST_LOGIN_IP],
               (entAppUser.getLastLoginIp() != null) ? entAppUser.getLastLoginIp() : "");
      } catch (Exception exc) {
   ...
   public static long syncExc(JSONObject jSONObject) throws DBException {
      long oid = 0;
      try {
         oid = Long.valueOf((String) jSONObject.get(PstAppUser.fieldNames[PstAppUser.FLD_USER_ID]));
         AppUser entAppUser = PstAppUser.parseJsonObject(jSONObject);
   ...
   private static AppUser parseJsonObject(JSONObject jsonObject) {
      ...
      try {
         ...
         entAppUser.setRegDate(Formater.formatDate(
               (String) jsonObject.get(PstAppUser.fieldNames[PstAppUser.FLD_REG_DATE]), "yyyy-MM-dd HH:mm:ss"));
         entAppUser.setUpdateDate(Formater.formatDate(
               (String) jsonObject.get(PstAppUser.fieldNames[PstAppUser.FLD_UPDATE_DATE]), "yyyy-MM-dd HH:mm:ss"));
         entAppUser.setUserStatus(
               Integer.valueOf((String) jsonObject.get(PstAppUser.fieldNames[PstAppUser.FLD_USER_STATUS])));
         entAppUser.setLastLoginDate(Formater.formatDate(
               (String) jsonObject.get(PstAppUser.fieldNames[PstAppUser.FLD_LAST_LOGIN_DATE]), "yyyy-MM-dd HH:mm:ss"));
